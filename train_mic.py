...
def get_args():
    ...
    # Data
    parser.add_argument('--h5_file', type=str, default='ecoli_peptides_featurised.h5',
...
def main():
    ...
    #Early Stopping
    early_stopping = EarlyStopping(patience=5, delta=0.0, verbose=True)
    best_state = None
    best_epoch = None
    best_val = float('inf')
    ...
    for epoch in range(1, args.epochs + 1):
        ...
        improved = early_stopping.check_early_stop(val_loss)
